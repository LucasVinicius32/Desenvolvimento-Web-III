...
import com.autobots.automanager.servico.ServiceEmpresa;
import com.autobots.automanager.servico.MercadoriaServico;
import com.autobots.automanager.servico.ServiceUser;
...
public class ControllerMercadoria {
  ...
  @Autowired
  public ServiceEmpresa servicoEmpresa;

  @Autowired
  public ServiceUser servicoUsuario;
